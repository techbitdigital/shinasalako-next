...
export const metadata = buildMetadata({
  ...
  description: "Fifteen questions. Five operating systems. One clear answer about where your business is silently leaking.",
    ...
    <main>
      <section className="py-16 md:py-24" style={{ background: "var(--navy)" }}>
        <div style={{ maxWidth: "780px" }} className="mx-auto px-5 md:px-8 text-center">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl mb-4" style={{ color: "#fff" }}>The Founder Diagnostic</h1>
