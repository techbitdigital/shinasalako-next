...
export async function POST(req: Request) {
  try {
    ...
    await resend.emails.send({
      ...
      to: [email],
      subject: `Your order confirmed \u2014 The Entrepreneur OS ${product}`,
      html: `
        <p>Hi ${name},</p>
        <p>Thank you for purchasing <strong>The Entrepreneur Operating System \u2014 ${product}</strong>.</p>
        ...
        <p>If you have not taken the Founder Diagnostic yet, it is the perfect companion to the book.</p>
    ...
    await resend.emails.send({
      ...
      subject: `New EOS book purchase \u2014 ${name} \u2014 ${product}`,
      html: `
