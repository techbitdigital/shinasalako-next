...
export const pricingTiers: PricingTier[] = [
  ...
  },
  {
    ...
    title: "Workbook & Program",
    desc: "Turn inspiration into evidence with a guided 12-week path.",
    price: "₦18,000",
    amount: 18000,
    features: ["Phase Assessment + 10 tools", "A worked example in each tool", "12-Week Transformation Program", "Reader discussion guide"],
  },
];
